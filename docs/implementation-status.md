...
| Spectral Bloom | Concept documented; awaiting approval | reference-directed concept | One persistent 3D particle body is continuously deformed by master-audio analysis rather than note events. Loudness controls breath and pressure; logarithmic spectral bands drive stable spatial modes; low frequencies move mass; mids create folds and lobes; highs add membrane detail; spectral flux drives bounded opening and spray; noisiness controls cohesion; and stereo information biases asymmetry. Simultaneous sounds naturally superpose in one coherent form. | Confirm the interpretation in the [Spectral Bloom concept](implementation/spectral-bloom-concept.md) before creating an implementation plan or code |
