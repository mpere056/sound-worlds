...
| Physics-first visual worlds | Two active engineering previews; two strengthened plans; one shelved experiment | in progress | Aurora Cyclotron and Phaseglass remain active engineering previews. Pendulum Cathedral and Singularity Slalom retain implementation-ready plans with distinct object-first and orbital foundations. Vortex Loom's certified physics experiment remains in the repository for learning and reference, but its concept and renderer are shelved after repeated visual review found that the shuttle-and-weave grammar did not produce a compelling music visualizer. | Continue Aurora and Phaseglass independently. Do not continue Vortex Loom or reuse its transported-fiber presentation. Evaluate Spectral Bloom as a separate full-spectrum audio-reactive research track |
