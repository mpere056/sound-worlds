...
steps, section palette shifts, track-derived strata, and vocal-halo envelopes;
its Pixi scene renders that data as a runner collecting light across a layered
waveform landscape.
Metro
